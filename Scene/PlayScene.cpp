...
void PlayScene::Initialize()
{
    ...
    player = new Player("D:/I2P2-Final-Project/Resource/images/play/enemy-1.png", MapWidth * BlockSize / 2.0f, MapHeight * BlockSize / 2.0f, 5.0f); // 路徑、初始座標、速度
}
...
void PlayScene::OnKeyDown(int keyCode)
{
    ...
    if (player)
    {
        player->Update(keyCode); // 將按鍵傳遞給 Player
    }
