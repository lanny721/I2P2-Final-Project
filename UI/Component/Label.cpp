...
namespace Engine {
    ...
    void Label::Draw() const {
        al_draw_text(font.get(), Color, Position.x - Anchor.x * GetTextWidth() - followCamera * GameEngine::GetInstance().GetActiveScene()->camera.x,
                      Position.y - Anchor.y * GetTextHeight() - followCamera * GameEngine::GetInstance().GetActiveScene()->camera.y, 0, Text.c_str());
    }
